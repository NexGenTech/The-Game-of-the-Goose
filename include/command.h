...
typedef enum enum_Command {NO_CMD = -1, UNKNOWN, EXIT, NEXT, BACK, TAKE, DROP, ROLL, LEFT, RIGHT, MOVE, INSPECT, TURNON, TURNOFF, OPEN, SAVE, LOAD} T_Command;           //An enumeration for all the commands
